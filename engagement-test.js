...
(async () => {
  ...
  ok(SV.plansFor('personal').length === 4 && SV.plansFor('business').length === 4, 'four personal tiers and four business tiers');
  ...
  ok(P.releaseInfo().version === '1.67.0', 'the release reports 1.67.0');
