...
step('the specification registry covers the 168 master sections + 8 platform requirements', () => {
  ...
  if (rows.length !== 176) throw new Error('registry has ' + rows.length + ' sections, expected 176');
