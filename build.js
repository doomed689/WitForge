...
step('the specification registry covers the 168 master sections + 7 platform requirements', () => {
  ...
  if (rows.length !== 175) throw new Error('registry has ' + rows.length + ' sections, expected 175');
