...
function otelExport(state) {
  ...
  return {
    resourceSpans: [{
      resource: { attributes: [{ key: 'service.name', value: { stringValue: 'witforge' } }, { key: 'service.version', value: { stringValue: (state.release && state.release.version) || '1.70.0' } }] },
      scopeSpans: [{
        scope: { name: 'witforge.platform', version: '1.70.0' },
