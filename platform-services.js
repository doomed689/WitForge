...
const PLANS = [
   ...
   * from A$30; the A$499 'enterprise' tier was retired. v1.76.1: the $0 Free
...
function otelExport(state) {
  ...
  return {
    resourceSpans: [{
      resource: { attributes: [{ key: 'service.name', value: { stringValue: 'witforge' } }, { key: 'service.version', value: { stringValue: (state.release && state.release.version) || '1.76.1' } }] },
      scopeSpans: [{
        scope: { name: 'witforge.platform', version: '1.76.1' },
