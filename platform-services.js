...
function otelExport(state) {
  ...
  return {
    resourceSpans: [{
      resource: { attributes: [{ key: 'service.name', value: { stringValue: 'witforge' } }, { key: 'service.version', value: { stringValue: (state.release && state.release.version) || '1.79.2' } }] },
      scopeSpans: [{
        scope: { name: 'witforge.platform', version: '1.79.2' },
